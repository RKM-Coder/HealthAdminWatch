...
public class TalukListAdapter extends RecyclerView.Adapter<TalukListAdapter.HorizontalViewHolder> implements Filterable {

    public Context mContext;
    ArrayList<BlockModel> list;
    ArrayList<BlockModel> listmain;
    ...
    public TalukListAdapter(Context mContext, ArrayList<BlockModel> list) {
    ...
    public void addall(ArrayList<BlockModel> getVendors) {
    ...
    public void onBindViewHolder(HorizontalViewHolder holder, final int position) {
        ...
        holder.txtname.setText("" + list.get(position).getBlockName());
    ...
    public interface OnClickMainView {
        void onClickMain(int position, BlockModel requestbodyVendor);
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<BlockModel> filteredList = new ArrayList<>();
                    for (BlockModel row : listmain) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                list = (ArrayList<BlockModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
