...
public class VillageGenericListAdapter extends RecyclerView.Adapter<VillageGenericListAdapter.HorizontalViewHolder> implements Filterable {

    public Context mContext;
    ArrayList<VillageModel> list;
    ArrayList<VillageModel> listmain;
    ...
    public VillageGenericListAdapter(Context mContext, ArrayList<VillageModel> list) {
    ...
    public void addall(ArrayList<VillageModel> getVendors) {
    ...
    public void onBindViewHolder(HorizontalViewHolder holder, final int position) {
        ...
        holder.txtname.setText("" + list.get(position).getVillageName());
    ...
    public interface OnClickMainView {
        void onClickMain(int position, VillageModel requestbodyVendor);
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<VillageModel> filteredList = new ArrayList<>();
                    for (VillageModel row : listmain) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                list = (ArrayList<VillageModel>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
