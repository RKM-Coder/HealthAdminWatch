 ...
 */
public class HWPaggingPatientListAdapter extends PagedListAdapter<PatientListDataItem,HWPaggingPatientListAdapter.ListViewHolder> {

    private ArrayList<PatientListDataItem> listString;
    private ArrayList<PatientListDataItem> listmain;
    ...
    public HWPaggingPatientListAdapter(Context context, ArrayList<PatientListDataItem> listString){
        super(PatientListDataItem.DIFF_CALLBACK);
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, final int position) {
        ...
        holder.tvRelation.setText(listString.get(position).getMobileNo());
   ...
   public class ListViewHolder extends RecyclerView.ViewHolder {
    ...
    public interface CheckedListener{
        void onItemCheckedFamilly(int position, PatientListDataItem item);
    }

   /* public void setValue(ArrayList<PatientListDataItem> list){
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<PatientListDataItem> filteredList = new ArrayList<>();
                    for (PatientListDataItem row : listmain) {

                        if (row.getName()!=null || row.getMobileNo()!=null) {

                            if (row.getName().toLowerCase().contains(charString.toLowerCase()) || row.getMobileNo().contains(charString)) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                listString = (ArrayList<PatientListDataItem>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }*/
