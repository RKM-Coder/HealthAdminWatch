 ...
 */
public class HWPatientListAdapter extends RecyclerView.Adapter<HWPatientListAdapter.ListViewHolder> implements Filterable {
    ...
    public HWPatientListAdapter(Context context, ArrayList<PatientListDataItem> listString){
