 ...
 */
public class DemoListAdapter extends RecyclerView.Adapter<DemoListAdapter.ListViewHolder> {
    ...
    public DemoListAdapter(Context context, ArrayList<ResPatientFamilyInfo> listString){
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.list_item_demo, parent, false);
