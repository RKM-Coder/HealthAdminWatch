...
public class DistrictRuralListAdapter extends RecyclerView.Adapter<DistrictRuralListAdapter.HorizontalViewHolder> implements Filterable {
    ...
    public DistrictRuralListAdapter(Context mContext, ArrayList<DistrictModel> list) {
